-- Atomically records cryptographic user confirmation and reserves execution.
-- This function does not sign, submit, broadcast, or call a chain provider.
...
COMMENT ON FUNCTION public.agent_reserve_wallet_signed_execution_v1(
  jsonb, jsonb, integer, integer
) IS
  'Persists verified wallet-signature confirmation and reserves execution atomically; never broadcasts.';
