...
async function submitAgentConversation(command, pendingId) {
  ...
  const hardMs = launchIntent ? 35_000 : skillIntent ? 20_000 : 15_000;
  const requestMs = launchIntent ? 30_000 : skillIntent ? 15_000 : 12_000;
  const waitMs = launchIntent ? 25_000 : skillIntent ? 12_000 : 10_000;
